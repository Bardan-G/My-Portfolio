  ...
  return (
    <section id="contact " className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color, color]
                        hover:bg-zinc-50 hover:text-zinc-950 active:hover:bg-zinc-50/80 reveal-up"
              >
                {icon}
              </a>
            ))}
        ...
        <form action="https://getform.io/f/aologynb" className="xl:pl-10 2xl:pl-20" method="POST">
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="name"
                required
                placeholder="neupanebardang@example.com"
                className="text-field reveal-up"
              />
            </div>
          </div>
